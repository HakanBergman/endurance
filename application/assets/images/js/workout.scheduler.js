            ...
            this.each(function() {
                ...
                $table.find('.day').droppable({
                    ...
                    drop: function(event, ui) {
                        ...
                        if (typeof $info.__class__ != 'undefined' && $info.__class__ == 'template_workout') {
                        ...
                        } else if ($info.__class__ == 'schedule_workout' || $info.__class__ == 'day_workout' || $info.__class__ == 'day_result') {
