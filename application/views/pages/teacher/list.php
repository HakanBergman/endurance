...
<table class="box schedules">
    ...
    <tr>
        ...
        <th style="width: 32px; background-color: #cccccc;" onmouseout="$('.tooltip').eq().text('');" onmouseover="$('.tooltip').eq().text('Ändra egenskaper');"><a href="/school/edit/{$school->id}"><img src="/assets/images/edit.png" height="20" /></a></th>
    </tr>
